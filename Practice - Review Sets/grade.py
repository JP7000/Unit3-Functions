...
def run_task1_tests():
    try:
        from performance1 import convert_to_stars
    except ImportError:
...
def run_task2_tests():
    try:
        from performance2 import format_review
    except ImportError:
...
def run_task3_tests():
    try:
        from performance3 import parse_rating
    except ImportError:
...
def run_task4_tests():
    try:
        from performance4 import validate_rating
    except ImportError:
